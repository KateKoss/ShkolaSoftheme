...
namespace HW20
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            lifecellOperator.AddAccount("Lena", "Kostycheva", "kos@gmail.com", new DateTime(2012, 5, 6));
            lifecellOperator.AddAccount("Lena2", "Kostycheva", "kos@gmail.com", new DateTime(2020, 5, 6));
